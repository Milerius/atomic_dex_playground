...
let
  brightColor* = ImVec4(x: 0.0, y: 149.0 / 255.0, z: 143.0 / 255.0, w: 1.0)
  darkColor* = ImVec4(x: 25.0 / 255.0, y: 40.0 / 255.0, z: 56.0 / 255.0, w: 1.0)

proc setKomodoStyle*(ctx: ptr t_antara_ui) =
  ...
  z: 0.80,
  w: 0.35)
  style.colors[ImGuiCol.TitleBg.int32] = darkColor
  style.colors[ImGuiCol.Header.int32] = brightColor